...
export const portfolioData = {
    ...
    projects: {
        ...
        list: [
            {
                title: 'Extractify',
                description: 'Extractify is a web-based timetable extraction and visualization system that automatically converts complex timetable data into clear, interactive schedules. It helps students and faculty access organized timetable information quickly and efficiently.',
                tags: ['HTML', 'CSS', 'Javascript', 'Python'],
                icon: <Layout size={32} className="text-gradient" />,
                github: 'https://github.com/yaashrane/Excel_Time_Table_Extractor',
                demo: 'https://extractify-zhi8.onrender.com',
                color: 'var(--accent-1)'
            },
            {

                title: 'CogniCare – Responsible AI Cognitive Monitoring Platform',
                description:
                    'An end-to-end Responsible AI platform for cognitive monitoring that enables hospitals and doctors to assess Cognitive Load and Emotional Arousal from physiological signals with SHAP explainability, confidence estimation, privacy-preserving inference, historical monitoring, and clinical workflow integration.',
                tags: [
                    'Python',
                    'Streamlit',
                    'Machine Learning',
    ...
    contact: {
        ...
        location: "Pune, India",
        socials: [
            { name: "Github", icon: <Github size={24} />, url: "https://github.com/bhagyesh-more" },
            { name: "LinkedIn", icon: <Linkedin size={24} />, url: "https//www.linkedin.com/in/bhagyesh-more" },
